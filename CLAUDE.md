...
`scripts/build-last-modified.js`: it uses the latest Git commit date for a clean
deck and today's date for a deck with uncommitted changes. Never type dates into
