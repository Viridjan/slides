...
| Deck | Slide | Stato |
|---|---|---|
| `ms01-tinkercad-introduzione.html` | 8 | ✅ creato |
| `ms02-modellazione-base.html` | 9 | ✅ creato (compatto — piano prevedeva 16) |
| `ms03-esportazione-stampa-3d.html` | 8 | ✅ creato |
| `ms04-classi-attivita.html` | 7 | ✅ creato |

Fatto anche: card nell'indice (`00-indice.html`), `.txt` companion per tutti e 4, prefisso `ms` in CLAUDE.md e README.

**Espansione possibile**: ms02 è più sintetico del piano — le proposte non implementate come slide dedicate (mouse e precisione, colori RGB/esadecimali, rotazione separata, mini-esercizio portachiavi) restano disponibili nelle sezioni sotto.

## Target merge suggerito

Implementato come nuova sezione/deck dedicata, per non appesantire troppo SU o PM.

- nuovo prefisso: `ms` = TinkerCAD / 3D
- `ms01-tinkercad-introduzione.html`
- `ms02-modellazione-base.html`
- `ms03-esportazione-stampa-3d.html`
- eventuale `ms04-classi-attivita.html`
...
## MS01 - Docenti, classi e modalita sicura
...
## MS02 - Dimensioni e proprieta forma
...
## MS02 - Colori RGB ed esadecimali
...
## MS03 - Dalla modellazione alla stampa 3D
...
## MS03 - Errori comuni nella stampa 3D
...
## MS04 - Aggiungere studenti e badge
...
- Esempi pratici semplici (targhetta, portachiavi, pedina, supporto cavo) — da usare in eventuali espansioni di ms02/ms03.
