...
const SOURCES = [
  ...
  ['circuiti integrati', 'https://www.computerhistory.org/siliconengine/timeline/', 'Evoluzione dei semiconduttori — Computer History Museum', /^hs06/],
  ['Hyper-Threading', 'https://www.intel.com/content/www/us/en/gaming/resources/hyper-threading.html', 'Hyper-Threading — Intel', /^hs06/],
  ['Transizione di ARPANET a TCP/IP', 'https://www.internetsociety.org/internet/history-internet/brief-history-internet/', 'Breve storia di Internet — Internet Society', /^hs06/],
  ['IA accelerata', 'https://computerhistory.org/stories/chatbots-decoded/', 'IA, reti neurali e accelerazione hardware — Computer History Museum', /^hs06/],
  ['schermi a colori', 'https://computerhistory.org/apple-timeline/', 'Apple II e grafica a colori — Computer History Museum', /^hs06/],
  ['2005 · Arduino', 'https://www.arduino.cc/en/about', 'Arduino — storia e progetto ufficiale', /^hs06/],
  ['machine learning', 'https://computerhistory.org/stories/chatbots-decoded/', 'Machine learning e accelerazione hardware — Computer History Museum', /^hs06/],
  ['Nokia 6110', 'https://newsroom.arm.com/blog/arm-official-history', 'Storia dell’architettura Arm', /^hs06/],
  ['big.LITTLE', 'https://newsroom.arm.com/blog/arm-official-history', 'Storia dell’architettura Arm', /^hs06/],
  ['Personal Computer 5150', 'https://www.ibm.com/history/personal-computer', 'IBM Personal Computer — IBM', /^hs06/],
  ['5.750 dollari', 'https://www.bls.gov/data/inflation_calculator.htm', 'Calcolatore dell’inflazione CPI — U.S. BLS', /^hs06/],
  ...
  ['Windows 95 porta', 'https://news.microsoft.com/announcement/launch-of-windows-95/', 'Lancio di Windows 95 — Microsoft', /^hs06/],
  ['identità del Mac', 'https://computerhistory.org/apple-timeline/', 'Cronologia dei computer Apple — Computer History Museum', /^hs06/],
  ['Apple silicon', 'https://www.apple.com/newsroom/2020/06/apple-announces-mac-transition-to-apple-silicon/', 'Transizione del Mac ad Apple silicon — Apple', /^hs06/],
  ['Chiavette USB', 'https://www.computerhistory.org/storageengine/portable-personal-storage-devices/', 'Dispositivi portatili di archiviazione — Computer History Museum', /^hs06/],
  ['Copia privata', 'https://www.normattiva.it/uri-res/N2Ls?urn%3Anir%3Astato%3Alegge%3A1941-04-22%3B633~art71sexies=', 'Copia privata, art. 71-sexies — Normattiva', /^hs06/],
  ['duplicare file che identificano persone', 'https://eur-lex.europa.eu/eli/reg/2016/679/oj', 'Regolamento generale sulla protezione dei dati — EUR-Lex', /^hs06/],
  ['Unsplash', 'https://unsplash.com/license', 'Licenza Unsplash', /^su04-01/],
  ['Pexels', 'https://www.pexels.com/license/', 'Licenza Pexels', /^su04-01/],
...
const FUNCTION_SOURCES = [
  ...
  ['add', 'https://docs.python.org/3/library/stdtypes.html#set-types-set-frozenset', 'set.add() — documentazione Python', /^pr06-02/],
  ['discard', 'https://docs.python.org/3/library/stdtypes.html#set-types-set-frozenset', 'set.discard() — documentazione Python', /^pr06-02/],
  ['count', 'https://docs.python.org/3/library/stdtypes.html#common-sequence-operations', 'sequence.count() — documentazione Python', /^pr06-02/],
  ['get', 'https://docs.python.org/3/library/stdtypes.html#mapping-types-dict', 'dict.get() — documentazione Python', /^pr06-02/],
  ['update', 'https://docs.python.org/3/library/stdtypes.html#mapping-types-dict', 'dict.update() — documentazione Python', /^pr06-02/],
  ['items', 'https://docs.python.org/3/library/stdtypes.html#mapping-types-dict', 'dict.items() — documentazione Python', /^pr06-02/],
