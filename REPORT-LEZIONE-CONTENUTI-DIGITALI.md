...
I cinque deck e i rispettivi `.txt` sono generati da `scripts/build-question-lesson.js`. Dopo modifiche eseguire il generatore, poi ricostruire gli indici di completezza e ricerca.
