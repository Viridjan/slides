...
| `inf02-*` | `in01`, `in04`, `in05` | Identita, SPID/PEC, reputazione e social integrati |
| `inf03-*`, `inf04-*`, `inf05-*`, `inf08-*` | `su05`-`su18` | Documenti, fogli di calcolo, presentazioni e automazione integrati |
| `inf06-*`, `inf07-*` | `in04`, `in05`, `su12` | Branding, social, hashtag e contenuti visuali integrati |
...
| --- | --- |
| DNS, domini, sottodomini, URL sospetti | `rw02-navigazione.html`, `rw03-domini.html` |
| Ricerca, SERP, operatori, affidabilita | `rw04-ricerca.html`, `rw07-affidabilita.html` |
| Salvataggio, download, screenshot, OCR, Creative Commons | `rw08-contenuti.html` |
| SPID, CIE, PEC, identita e reputazione | `in01-identita.html`, `in04-branding.html`, `in05-social.html` |
| Social, hashtag, calendario editoriale, contenuti | `in05-social.html` |
| Documenti, fogli, formule, CERCA.VERT, testo, pivot e presentazioni | `su05-documenti.html`-`su13-presentazioni.html` |
| Fogli avanzati, query, macro, VBA e Google Apps Script | `su14-fogli-calcolo-avanzati.html`-`su18-google-apps-script.html` |
...
| Scratch, Micro:bit, CreateAI | `sc01-introduzione.html`, `sc02-questionario.html`, `mb01-microbit.html`, `mb02-createai.html` |
| TinkerCAD, modellazione e stampa 3D | `td01-tinkercad-introduzione.html`-`td04-classi-attivita.html` |
